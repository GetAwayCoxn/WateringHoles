...
def register_user(request):
    ...
    try:
        new_user = Core_User.objects.create_user(username = username, email = email, password = password, is_superuser = super_user, is_staff = staff)
        new_user.save()
...
def user_login(request):
    # Handle login, be sure any axios calls have correct CSRF tokens
    username = request.data['username']
    password = request.data['password']
